...
import { RadioGroup, Radio, CustomRadio } from '@components/radio-group'
...
function Form({ setTotalTip, setTotal }: Props) {
    ...
    return (
        <div className="w-full h-auto">
            <NumberField label="Bill" minValue={0} formatOptions={{ minimumFractionDigits: 2, maximumFractionDigits: 2 }} value={bill} onChange={setBill}>
                <svg className="w-3 h-auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 11 17">
            ...
            <RadioGroup label="Select Tip %" setTip={setTip}>
            ...
            <NumberField label="Number of People" minValue={0} defaultValue={0} formatOptions={{ maximumFractionDigits: 0 }} value={people} onChange={setPeople}>
                <svg className="w-3.5 h-auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 13 16">
