...
function Result({
    ...
    return (
        <div className="w-full h-auto px-6 pt-10 pb-6 bg-very-dark-cyan rounded-[0.875rem] lg:flex lg:flex-col lg:justify-start items-start lg:ml-6 lg:p-12">
            ...
            <div className="flex flex-col w-full h-auto mb-6 2xs:flex-row 2xs:justify-between 2xs:items-center">
                ...
                <p className="text-strong-cyan text-center text-[2rem] font-bold 2xs:text-right">{ numberFormater.format(tipPerPerson) }</p>
            </div>
            ...
            <div className="flex flex-col w-full h-auto mb-8 2xs:flex-row 2xs:justify-between 2xs:items-center">
                ...
                <p className="text-strong-cyan text-center text-[2rem] font-bold 2xs:text-right">{ numberFormater.format(totalPerPerson) }</p>
            </div>
